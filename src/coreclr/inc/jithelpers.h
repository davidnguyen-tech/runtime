...
// pfnHelper is set to NULL if it is an unused helper.
    ...
    DYNAMICJITHELPER_NOINDIRECT(CORINFO_HELP_JIT_PINVOKE_OBJC_EXCEPTION_CHECK, NULL, METHOD__OBJCMARSHAL__THROW_PENDING_EXCEPTION)
#else
    JITHELPER(CORINFO_HELP_JIT_PINVOKE_OBJC_EXCEPTION_CHECK, NULL, METHOD__NIL)
#endif
