...
// pfnHelper is set to NULL if it is an unused helper.
    ...
    DYNAMICJITHELPER_NOINDIRECT(CORINFO_HELP_JIT_PINVOKE_END_CHECK_OBJ_EXCEPTION, NULL, METHOD__OBJCMARSHAL__THROW_PENDING_EXCEPTION)
#else
    JITHELPER(CORINFO_HELP_JIT_PINVOKE_END_CHECK_OBJ_EXCEPTION, NULL, METHOD__NIL)
#endif
